class stage_one_vegetables extends Phaser.Scene {
    ...
    tab_makeInteractive() {
        ...
        this.tab_left.on("pointerdown", () => {
            ...
            //remove previous time events
            //to avoid time event overlapped
            //this.beltSpeed_Normal.remove(false); 
            //this.beltSpeed_Hard.remove(false); 
            //this.beltSpeed_Expert.remove(false); 
            //this.beltSpeed_End.remove(false); 
