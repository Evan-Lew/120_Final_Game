class tutorial_4_2 extends Phaser.Scene {
    constructor() {
        super("tutorial_4_2");
    ...
    create() {
        ...
        this.background_field5 = this.add.tileSprite(0, 0, 940, 720, 'price_list2').setOrigin(0, 0);
    ...
    text_setup() {
        ...
        this.tab_main_text = this.add.text(390, 42, "Price", tab_main_TextConfig);
        ...
        this.menu1_rec = this.add.rectangle(80, 70, 120, 50, 0xfafafa).setOrigin(0);
        this.menu1_rec.setInteractive();
        this.menu1_text = this.add.text(80, 70, "Previous", text_menu).setOrigin(0);
        ...
        this.menu1_rec.on('pointerover', function () {
            this.menu1_text.destroy();
            this.menu1_text = this.add.text(80, 70, "Previous", text_menu_colorChange).setOrigin(0);
        }, this) //mouse managment is done
    ...
    makeDialog(){
        ...
        this.dialog = this.cache.json.get('tutorial_4_2');
